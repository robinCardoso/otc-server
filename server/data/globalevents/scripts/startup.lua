...
function onStartup()
	...
	-- war
    db.asyncQuery('UPDATE `guildwar_arenas` SET `inuse` = 0, `guild1` = 0, `guild2` = 0, `start` = 0, `maxplayers` = 0, `duration` = 0, `challenger` = 0, `playersOnTeamA` = 0, `pending` = 0, `playersOnTeamB` = 0')
