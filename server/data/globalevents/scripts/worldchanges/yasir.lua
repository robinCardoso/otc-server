...
-- ATENÇÃO: Game.loadMap() com .otbm parcial (yasir/*.otbm) redefine width/height do mapa
-- inteiro e deixa o resto do mundo sem tiles válidos → crash 0xC0000005 no login (ERROR 10054 no OTC).
-- Manter false até existir overlay de mapa no C++; ver docs/TROUBLESHOOTING.md (seção Yasir).
