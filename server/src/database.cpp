...
bool Database::connect()
{
	...
	// MariaDB 3.4+ may force SSL on localhost; disable for local XAMPP
	my_bool ssl = false;
	mysql_options(handle, MYSQL_OPT_SSL_VERIFY_SERVER_CERT, &ssl);
	mysql_options(handle, MYSQL_OPT_SSL_ENFORCE, &ssl);
