...
function init()
  ...
  g_keyboard.bindKeyDown('Ctrl+F', toggleChatShortcut, gameRootPanel)
...
function toggleChatShortcut()
  if not g_game.isOnline() or not consoleToggleChat then return end
...
function enableChat(temporarily)
  ...
  if consoleToggleChat:isChecked() then
    consoleToggleChat.onCheckChange = nil
    consoleToggleChat:setChecked(false)
    consoleToggleChat.onCheckChange = toggleChat
  end
...
function terminate()
  ...
  g_keyboard.unbindKeyDown('Ctrl+F', gameRootPanel)
...
function online()
  ...
  -- Sincronizar o estado da movimentação WASD de acordo com o checkbox
  if consoleToggleChat then
    if consoleToggleChat:isChecked() then
      modules.game_walking.enableWSAD()
    else
      modules.game_walking.disableWSAD()
